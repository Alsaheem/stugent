              ...
              <div className="row">
                <div className="col-md-8">
                  ...
                  <p className="mt-4">
                    ...
                    neque quod accusamus rem quia magnam magni dolorum facilis
                    ullam minima perferendis? Exercitationem at quaerat commodi
                    id libero eveniet harum perferendis laborum molestias quia.
                  </p>
                </div>
              ...
              <div className="row text-center">
                <div className="col-md-4">
                  ...
                  <p className="text-success">
                    <i className="fas fa-award text-success mb-3" /> Realtor
                  </p>
                  <hr />
                  <p>
                    <i className="fas fa-phone" /> (555)-555-5555
                  </p>
                  <p>
                    <i className="fas fa-envelope-open" /> kyle@btrealestate.co
                  </p>
                </div>
                <div className="col-md-4">
                  <img
                  ...
                  <hr />
                  <p>
                    <i className="fas fa-phone" /> (444)-444-4444
                  </p>
                  <p>
                    <i className="fas fa-envelope-open" /> mark@btrealestate.co
                  </p>
                </div>
                <div className="col-md-4">
                  <img
                  ...
                  <hr />
                  <p>
                    <i className="fas fa-phone" /> (333)-333-3333
                  </p>
                  <p>
                    <i className="fas fa-envelope-open" /> jenny@btrealestate.co
                  </p>
                </div>
              </div>
            </div>
